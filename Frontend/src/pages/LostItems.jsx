    ...
    const fetchItems = async () => {
      try {
        ...
        if (response.success) {
          ...
          const lostItems = response.data.filter(item => item.itemType === 'Lost');
          setItems(lostItems);
        }
      } catch (err) {
  ...
  const quickActions = [
    {
      ...
      description: "Post a new lost item report",
      route: "/report-lost",
    ...
    },
    {
      ...
      description: "Create a found item post from here",
      route: "/report-found",
      icon: HiOutlinePlusCircle,
    ...
    },
    {
      ...
      description: "Switch to the found items list",
      route: "/found-items",
    ...
    <>
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 text-white py-8 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="mt-2 text-cyan-100">Search through reported lost items</p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          >
            {filteredItems.map((item) => (
              ...
              >
                <div className="h-40 bg-gradient-to-br from-blue-300 to-cyan-300 flex items-center justify-center text-lg font-semibold text-gray-700 p-4 text-center">
                  {item.imageUrl ? (
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
          >
            <p className="text-2xl text-gray-600 mb-4">No lost items found</p>
            <button
              onClick={() => {
                setSearchTerm("");
